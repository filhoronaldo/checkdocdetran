...
export default {
	...
	theme: {
        ...
        detran: {
          DEFAULT: 'hsl(var(--detran))',
          light: 'hsl(var(--detran-light))',
          dark: 'hsl(var(--detran-dark))',
          foreground: 'hsl(var(--detran-foreground))'
        }
			},
			borderRadius: {
				lg: 'var(--radius)',
        ...
        'check-mark': 'check-mark 0.4s ease-out forwards'
			},
      fontFamily: {
